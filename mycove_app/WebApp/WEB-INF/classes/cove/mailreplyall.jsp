...
<head>
 ...
 //function replyall()
 {
 	...
 	temp.action='<%=request.getContextPath()%>/MailView.do?formAction=replyall';
     temp.submit();
 }
...
<html:form action="/mailreplyall.do" focus="replyMessage" >
<html:hidden property="formAction" />
<html:hidden property="id"></html:hidden>
<jsp:include page="/jsp/pub/header.jsp"  flush="true" />

<h1>Mail Reply All</h1>
                  
				            
                <p>
					<label class="label">To</label>
					<html:text styleClass="textbox" property="replyToAll" readonly="true" />
	...
	<p>
			...
			<html:submit property="action" styleClass="replyAll-button" onclick="replyall()">
				<bean:message key="button.replyall" />
			</html:submit> 
