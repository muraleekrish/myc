...
public class CustomForm extends ActionForm{
		...
		/**
		 * @return the customsubject
		 */
		public String getCustomsubject() {
			return customsubject;
		}
		/**
		 * @param customsubject the customsubject to set
		 */
		public void setCustomsubject(String customsubject) {
			this.customsubject = customsubject;
		}
		/**
		 * @return the custommessageText
		 */
		public String getCustommessageText() {
			return custommessageText;
		}
		/**
		 * @param custommessageText the custommessageText to set
		 */
		...
		public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
			...
			/*if (FormUtil.isNullOrBlank(this.getTemplateId()))
				errors.add("templateId", new ActionError("select.tempName"));
