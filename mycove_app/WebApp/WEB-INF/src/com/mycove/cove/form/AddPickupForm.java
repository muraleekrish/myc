...
public class AddPickupForm extends ActionForm{
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		if (FormUtil.isNullOrBlank(this.getPickupDate()))
			errors.add("pickupDate", new ActionError("select.pickupdate"));	
		if (FormUtil.isNullOrBlank(this.getPickupBy()))
			errors.add("pickupBy", new ActionError("select.pickupby"));
