...
public class MessageHandler {
	...
	public void saveEmail(Property property, User mailFromUser, User mailToUser,
			List<String> emailTo, String messageText, String subject) throws Exception {
		...
		messagesTos.add(new MessagesTo(mailToUser, messageFrom));
		...
		messagesTos1.add(new MessagesTo(mailToUser, messageTo));
