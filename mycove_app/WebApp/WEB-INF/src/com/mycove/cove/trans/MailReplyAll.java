...
public class MailReplyAll extends MessageHandlerForward {
	
	private final static Logger log = Logger.getLogger(MailReplyAll.class); 
	...
	public void execute(MailViewForm mailViewForm, Long userId,List<Long>emailToUserIds ) throws Exception {
		log.info("Mail ReplyToAll  execution starts...");
